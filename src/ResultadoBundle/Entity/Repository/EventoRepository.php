    ...
    */
    ...
    public function getRows($request,$user)
    {
        ...
        if ($user->hasRole('ROLE_COORDINADOR')){
            $query->andwhere('?2 MEMBER OF s.coordinadores')
                    ->setParameter(2,$user);
        }
    ...
    public function getFilteredRows($request,$user)
    {
        ...
        if ($user->hasRole('ROLE_COORDINADOR')){
            $query
                    ->andwhere('?2 MEMBER OF s.coordinadores')
                    ->setParameter(2,$user);
        }
        return $query->getQuery()->setParameter(1,'%'.$request->get('search')['value'].'%')->getSingleScalarResult();
    }
