...
/**
 * ResultadoBundle\Entity\Modalidad
 * @ORM\Table(name="Modalidad")
 * @ORM\Entity(repositoryClass="ResultadoBundle\Entity\Repository\ModalidadRepository")
 */
class Modalidad
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="Evento", mappedBy="modalidad")
     */
    private $eventos;
