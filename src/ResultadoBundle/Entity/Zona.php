...
class Zona
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="PlazaZona", mappedBy="zona", cascade={"all"})
     ...
     * Set liga
     *
     * @param \ResultadoBundle\Entity\CompetenciaLiga $liga
     * @return Zona
     */
    public function setLiga(\ResultadoBundle\Entity\CompetenciaLiga $liga = null)
    {
        $this->liga = $liga;
     ...
     * Get liga
     *
     * @return \ResultadoBundle\Entity\CompetenciaLiga 
     */
     ...
     * Add plaza
     *
     * @param \ResultadoBundle\Entity\PlazaZona $plaza
     * @return Competencia
     */
    public function addPlazas(\ResultadoBundle\Entity\PlazaZona $plaza)
    {
        $this->plazas[] = $plaza;
        $plaza->setZona($this);
     ...
     * @param \ResultadoBundle\Entity\PlazaZona $plaza
     */
    public function removePlazas(\ResultadoBundle\Entity\PlazaZona $plaza)
    {
     ...
     * @return Competencia
     */
    public function addPartido(\ResultadoBundle\Entity\Partido $partido)
    {
     ...
     * @param \ResultadoBundle\Entity\Partido $partido
     */
    public function removePartido(\ResultadoBundle\Entity\Partido $partido)
    {
     ...
     * Add plazas
     *
     * @param \ResultadoBundle\Entity\PlazaZona $plazas
     * @return Zona
     */
    public function addPlaza(\ResultadoBundle\Entity\PlazaZona $plazas)
    {
        $this->plazas[] = $plazas;
