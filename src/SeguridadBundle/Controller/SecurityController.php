            ...
            if ($form->isSubmitted() && $form->isValid()) {
                ...
                if ($user && $user->isValidEmail($form["_email"]->getData())){
                    ...
                    try {
                        ...
                        $em->flush();
                        $this->get('mailer')->send($message);
                        return new JsonResponse(array('success' => true, 'message' => '<h4>Excelente!</h4><p>Su <strong>contraseña</strong> fue reseteada con éxito. Se envió un <strong>e-mail</strong> con las instrucciones para <strong>completar el proceso</strong>.</p><p> Gracias por utilizar Plenus!.</p>'));
                    }
                    catch(\Exception $e )
                    {
