...
{  
    ...
    */
     ...
     * Add coordina
     *
     * @param \InscripcionBundle\Entity\Segmento $coordina
     *
     * @return Usuario
     */
    public function addCoordina(\InscripcionBundle\Entity\Segmento $coordina)
    {
     ...
     * @param \InscripcionBundle\Entity\Segmento $coordina
     */
    public function removeCoordina(\InscripcionBundle\Entity\Segmento $coordina)
    {
     ...
     * Set cargo
     *
     * @param \SeguridadBundle\Entity\Cargo $cargo
     *
     * @return Usuario
     */
    public function setCargo(\SeguridadBundle\Entity\Cargo $cargo = null)
    {
        $this->cargo = $cargo;
     ...
     * Get cargo
     *
     * @return \SeguridadBundle\Entity\Cargo
     */
